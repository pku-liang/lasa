...
int main()
{
    ...
    Halide::Runtime::Buffer<float> A(TOTAL_K, TOTAL_I), x(TOTAL_K), y(TOTAL_I);
    ...
    Halide::Runtime::Buffer<float> c(III, II, I);
    symv(A, x, y, alpha, beta, c);
    ...
    for (int i = 0; i < I; i++)
        for (int ii = 0; ii < II; ii++)
            for (int iii = 0; iii < III; iii++) {
                ...
                golden = alpha * golden + beta * y(total_i);
                assert(fabs(golden - c(iii, ii, i)) < 0.005*fabs(golden));
            }
#else
