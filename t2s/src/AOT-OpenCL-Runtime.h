...
extern int32_t halide_device_and_host_free(void *, void *);
extern int32_t halide_device_and_host_malloc(void *, struct halide_buffer_t *, struct halide_device_interface_t const *);
